...
class LectureCancellationFragment : Fragment() {
        ...
        AsyncLayoutInflater(context).inflate(R.layout.dialog_lecture_filter, null) { view, _, _ ->
            ...
            AlertDialog.Builder(context)
                    ...
                    .setPositiveButton(R.string.action_apply) { _, _ ->
                        val order = view.order_spinner.selectedItem as LectureOrderType
                        ...
                        defaultSharedPreferences.edit { putString("lecture_cancel_order_type", order.name) }
                    }
    ...
    companion object {
        @JvmStatic
        fun newInstance() = LectureCancellationFragment()
    }
}
