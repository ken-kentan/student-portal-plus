...
class NoticeDetailActivity : AppCompatActivity() {
    ...
    private val viewModel by lazy(LazyThreadSafetyMode.NONE) {
        ViewModelProvider(this, viewModelFactory).get(NoticeDetailViewModel::class.java)
    }
    ...
    private fun NoticeDetailViewModel.subscribe() {
        val activity = this@NoticeDetailActivity
