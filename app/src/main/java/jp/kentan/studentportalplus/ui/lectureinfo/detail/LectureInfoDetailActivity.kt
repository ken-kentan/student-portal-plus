...
import jp.kentan.studentportalplus.databinding.ActivityLectureInfoDetailBinding
import jp.kentan.studentportalplus.ui.ViewModelFactory
import javax.inject.Inject

class LectureInfoDetailActivity : AppCompatActivity() {

    companion object {
        private const val EXTRA_ID = "ID"

        fun createIntent(context: Context, id: Long) =
                Intent(context, LectureInfoDetailActivity::class.java).apply {
    ...
    private val viewModel by lazy(LazyThreadSafetyMode.NONE) {
        ViewModelProvider(this, viewModelFactory).get(LectureInfoDetailViewModel::class.java)
    }

    private lateinit var binding: ActivityLectureInfoDetailBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_lecture_info_detail)
    ...
    private fun LectureInfoDetailViewModel.subscribe() {
        val activity = this@LectureInfoDetailActivity
